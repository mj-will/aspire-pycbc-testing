...
--output-file marg_150914_aspire.hdf \
--seed 0 \
--force \
--verbose
...
--input-file marg_150914_aspire.hdf \
--output-file demarg_150914_aspire.hdf \
--nprocesses 1 \
...
--input-file demarg_150914_aspire.hdf \
--output-file demarg_150914_aspire.png \
--parameters \
